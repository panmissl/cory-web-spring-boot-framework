...
public class URLHelper {
	...
	/**
	 * 解析returnUrl的正确的值。一般直接返回，但是对于特殊的returnUrl参数，需要特殊处理。
	 * @param request
	 * @return
	 */
	public static String parseReturnUrl(HttpServletRequest request) {
	 ...
	 * @return
	 */
	public static String fixReturnUrlForLogout(HttpServletRequest request, String redirectUrl) {
		return redirectUrl;
	}
